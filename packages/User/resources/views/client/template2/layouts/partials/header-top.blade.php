             ...
             <div class="modal-body">
                 <div class="col-lg-12 col-md-12 me-3">
                     <div class="image-holder">
                         <img src="{{ asset('assets/template2/images/summary-item1.jpg') }}" alt="Shoes">
                     </div>
                 </div>
                     ...
                     <div class="shopping-cart-content">
                             ...
                             <div class="mini-cart-item d-flex border-bottom pb-3">
                                 <div class="col-lg-2 col-md-3 col-sm-2 me-4">
                                     <a href="#" title="product-image">
                                         <img src="{{ asset('assets/template2/images/single-product-thumb1.jpg') }}"
                                             class="img-fluid" alt="single-product-item">
                                     </a>
                                 </div>
                         ...
                         <div class="mini-cart cart-list p-0 mt-3">
                             <div class="mini-cart-item d-flex border-bottom pb-3">
                                 <div class="col-lg-2 col-md-3 col-sm-2 me-4">
                                     <a href="#" title="product-image">
                                         <img src="{{ asset('assets/template2/images/single-product-thumb2.jpg') }}"
                                             class="img-fluid" alt="single-product-item">
                                     </a>
                                 </div>
                                 <div class="col-lg-9 col-md-8 col-sm-8">
                         ...
                         <div class="col-lg-12 mx-auto">
                             <form action="{{ route('login') }}" method="POST">
                                 ...
                                 <div class="modal-footer mt-5 d-flex justify-content-center">
                                     <button type="submit"
                                         class="btn btn-red hvr-sweep-to-right dark-sweep">Login</button>
